$(document).ready(function() {
        ...
        let card = $(
          '<div class="card border-0 mr-2" style="width: 16rem;" attr-next="' + nextCard + '" attr-prev="' + prevCard + '">' +
            ...
            '<ul class="list-group list-group-flush">' +
              '<li class="list-group-item border-0 color-grey-smile">' + item.sub_title + '</li>' +
  ...
  setTimeout(function(){
    ...
    loadCarouselVideos("https://smileschool-api.hbtn.info/xml/popular-tutorials", "popularVideosContent", "loaderPopularVideos", dataPopularVideos);
    loadCarouselVideos("https://smileschool-api.hbtn.info/xml/latest-videos", "latestVideosContent", "loaderLatestVideos", dataLastestVideos);
  }, 1000);
